sap.ui.define(
    "com/ibm/zproduct02/controls/Book",
    [
    ...
    function (Control, Button, Image, Link, Text) {
      ...
      var Book = Control.extend("com.ibm.zproduct02zproduct02.controls.Book", {
        // the control API:
        metadata: {
          properties: {
            ...
            price: { type: "float" },
            currencyCode: {
              // type: "com.ibm.md.controls.CurrencyCode",
              defaultValue: "USD",
          ...
          associations: {
            relatedBooks: {
              type: "com.ibm.zproduct02zproduct02.controls.Book",
              multiple: true,
        ...
        renderer: {
          render: function (oRm, oControl) {
            ...
            oRm.write("<div>");
            oRm.write(
              "<div>Title            : " + oControl.getTitle() + "</div>"
            );
            oRm.write(
              "<div>Author           : " + oControl.getAuthor() + "</div>"
            );
            oRm.write(
            ...
            oRm.write(
              "<div>Pages            : " + oControl.getNumberOfPages() + "</div>"
            );
            oRm.write(
      ...
      //overwrite setter
      com.ibm.zproduct02zproduct02.controls.Book.prototype.setCoverPictureUrl = function (sVal) {
        if (sVal) {
      ...
      com.ibm.zproduct02zproduct02.controls.Book.prototype.exit = function () {
