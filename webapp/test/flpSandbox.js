		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comibmzproduct02zproduct02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmzproduct02zproduct02-display": {
								"semanticObject": "comibmzproduct02zproduct02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.zproduct02.zproduct02",
									"url": sap.ui.require.toUrl("com/ibm/zproduct02/zproduct02")
								}
							}
						}
					}
